...
async function getSongs(folder) {
    currFolder = folder;
    let a = await fetch(`https://github.com/mursaleen-nisar/spotify/tree/main/${folder}/`);
...
async function displayAlbums() {
    let a = await fetch(`https://github.com/mursaleen-nisar/spotify/tree/main/Songs/`);
    let response = await a.text();
    let div = document.createElement("div");
    div.innerHTML = response;
    ...
    let array = Array.from(anchors);
        ...
        if (e.href.includes("/songs/")) {
            ...
            let a = await fetch(`https://github.com/mursaleen-nisar/spotify/tree/main/Songs/${folder}/info.json`);
